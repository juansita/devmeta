# Feature Spec — Hierarchy Diagram

**Iteration:** 01.2
**Wave:** 1 (parallel with the other three)
**Owns:** `slides/pages/02-model.md`

---

## Scope

Replace the placeholder on slide 4 with a Mermaid diagram of nested containment: an increment holds iterations, an iteration holds features, a feature holds tasks. This is the diagram the whole deck leans on.

---

## Architecture

**Modifies:** `slides/pages/02-model.md` — slide 4 only. Touch no other file.
